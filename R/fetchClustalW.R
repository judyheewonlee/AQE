...
#'
#' @return The alignment generated by ClustalW in the form of a seqinr
#' alignment.
#'
#' @export
#'
...
fetchClustalW <- function(inputSeqs, readType = c("AA", "DNA", "RNA"),
  ...
  # Use msa library to create a ClustalW alignment
  alignment <- msa::msaClustalW(seq, cluster, gapOpening, gapExtension,

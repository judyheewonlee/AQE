...
#' \code{\link[msa]{msaMuscle}} function which provides details about the
#' parameters that adjust the alignment.
#'
...
#' @examples
#' \dontrun{
#' muscle <- fetchMuscle("BB11001", readType = "AA")
#'
#' writeAln("BB11001")
#' aln <- fetchMuscle("inst/extdata/Output/BB11002.mfa",
...
fetchMuscle <- function(inputSeqs, readType = c("AA", "DNA", "RNA"),
  ...
  if (xor(is.null(aln), !file.exists(inputSeqs))) {
    ...
    # the database. Then convert the mfa into an XStringSet
      ...
      writeAln(inputSeqs, fileName = "out", directory = "inst/extdata/temp")
      seq <- convertXStringSet("inst/extdata/temp/out.mfa", readType)
      file.remove("inst/extdata/temp/out.mfa")
    }
  }
